...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      !   wshdyro(104) = wshdyro(104) / 12.  
          ...
          if (iscen == 1) then
          write (output_std_num,6300) iyr, wshdyro(1), wshdyro(3), wshdyro(4),      &
    ...
    ! &            wshdyro(99),wshdyro(100),wshdyro(101),
    ! &            wshdyro(102),wshdyro(103),wshdyro(104),wshdyro(105),
    ! &            wshdyro(106)
          else if (isproj == 1) then
          write (output2_std_num,6300) iyr, wshdyro(1), wshdyro(3), wshdyro(4),      &
                 wshdyro(104), wshdyro(5), wshdyro(109), wshddayo(35),  &
                 wshdyro(7), wshdyro(108), wshdyro(6), wshdyro(12),     &
                 wshdyro(42), wshdyro(45), wshdyro(46), wshdyro(44),    &
                 wshdyro(40), wshdyro(43), wshdyro(41), wshdyro(111)
        ...
        if (iprint /= 1 .and. iprint/= 3) then    
          ...
          do j = 1, nhru
            ...
            if (sum > 0. .and. iprp == 1) then
                write (30,5100) subnum(j), hruno(j), iyr,   (hrupsty(k,1,j), hrupsty(k,2,j), k = 1, npmx)
            end if
            end if
          end do
   ...
   !! annual write--sediment routing (.sed)
          ...
          do j = 1, nres
            ...
            if (iyr >= iyres(j)) then
              ...
              write (output_rsv_num,5800) j, iyr, res_vol(j), resouty(1,j),          &
              ...
              write (output2_rsv_num,5800) j, iyr, res_vol(j), resouty(1,j),         &
                            resouty(2,j), resouty(19,j), resouty(17,j), &
                            resouty(18,j), resouty(3,j), resouty(4,j),  &
                            resouty(5,j),                              &
                            (resouty(k,j), k = 22, 23), resouty(38,j), &
              ...
              write (output_rsv_num,6800) j, iyr, res_vol(j), resouty(1,j),          &
                            resouty(2,j), resouty(19,j), resouty(17,j), &
                            resouty(18,j), resouty(3,j), resouty(4,j), &
                            resouty(5,j),                              &
                            (resouty(k,j), k = 22, 23), resouty(38,j), &
      ...
      !    if(cswat == 2)  rchaao2 = rchaao2 + rchyro2              !!output2.rch-------------------
 ...
 6300  format (/i5,15f8.2,1x,4f8.2,60f8.2//)     
