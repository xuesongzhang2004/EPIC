...
!! initialize variables
      ...
      do ii = 1, nstep_rch   ! subhourly time step, jaehak jeong
        flohr = 0.
        sedhr = 0.
        orgnhr = 0.
        orgphr = 0.
        ...
        if (ifirsthr(inum1) == 0) then
          read (hour_in_num+inum1,*) idap, iyp, ihr, flohr, sedhr, orgnhr,      &
      ...
      QHY(ii,ihout,IHX(1)) = hhvaroute(2,ihout,ii) / (dthy * 3600.) !!R673 8_16_19 nbs !added by Jaehak for subdaily routing, 2019
