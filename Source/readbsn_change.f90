...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      integer :: eof, numlu,ii,kk
      real :: escobsn, epcobsn
      real :: co2_x2, co2_x                         !!R682 10/20/21 nbs
      
!!      real :: r2adj_bsn  !D. Moriasi 4/8/2014    
    !!---------Du----stream temperature-----
      integer psub, phru
      !!---------Du----stream temperature-----
...
!! read basin parameters
      do
      read (bsnfile_num,1000) titldum
      read (bsnfile_num,1000) titldum
      read (bsnfile_num,1000) titldum
      read (bsnfile_num,*) sftmp
      read (bsnfile_num,*) smtmp
      read (bsnfile_num,*) smfmx
      read (bsnfile_num,*) smfmn
      read (bsnfile_num,*) timp
      read (bsnfile_num,*) snocovmx
      read (bsnfile_num,*) sno50cov
      read (bsnfile_num,*) ipet
      read (bsnfile_num,1000) petfile
      read (bsnfile_num,*) escobsn
      read (bsnfile_num,*) epcobsn
      read (bsnfile_num,*) evlai
      read (bsnfile_num,*) ffcb
      read (bsnfile_num,1000) titldum
      read (bsnfile_num,*) ievent
      read (bsnfile_num,*) icrk
      read (bsnfile_num,*) surlag_bsn
      read (bsnfile_num,*) adj_pkr
      read (bsnfile_num,*) prf_bsn
      read (bsnfile_num,*) spcon_bsn
      read (bsnfile_num,*) spexp_bsn
      read (bsnfile_num,1000) titldum
      read (bsnfile_num,*) rcn_sub_bsn
      read (bsnfile_num,*) cmn_bsn
      read (bsnfile_num,*) n_updis
      read (bsnfile_num,*) p_updis
      read (bsnfile_num,*) nperco_bsn
      read (bsnfile_num,*) pperco_bsn
      read (bsnfile_num,*) phoskd_bsn
      read (bsnfile_num,*) psp_bsn
      read (bsnfile_num,*) rsdco
      read (bsnfile_num,1000) titldum
      read (bsnfile_num,*) percop
      read (bsnfile_num,1000) titldum
      read (bsnfile_num,*) isubwq
      read (bsnfile_num,1000) titldum
      read (bsnfile_num,*) wdpq
      read (bsnfile_num,*) wgpq
      read (bsnfile_num,*) wdlpq
      read (bsnfile_num,*) wglpq
      read (bsnfile_num,*) wdps
      read (bsnfile_num,*) wgps
      read (bsnfile_num,*) wdlps
      read (bsnfile_num,*) wglps
      read (bsnfile_num,*) bactkdq
      read (bsnfile_num,*) thbact
      read (bsnfile_num,*) wof_p
      read (bsnfile_num,*) wof_lp
      read (bsnfile_num,*) wdpf
      read (bsnfile_num,*) wgpf
      read (bsnfile_num,*) wdlpf
      read (bsnfile_num,*) wglpf
      read (bsnfile_num,1001) ised_det
      read (bsnfile_num,1000) titldum
      read (bsnfile_num,*) irte
      read (bsnfile_num,*) msk_co1
      read (bsnfile_num,*) msk_co2
      read (bsnfile_num,*) msk_x
      read (bsnfile_num,*) ideg
      read (bsnfile_num,*) iwq
      read (bsnfile_num,1000) wwqfile
      read (bsnfile_num,*) trnsrch
      read (bsnfile_num,*) evrch
      read (bsnfile_num,*) irtpest
      read (bsnfile_num,*) icn
      read (bsnfile_num,*) cncoef
      read (bsnfile_num,*) cdn_bsn
      read (bsnfile_num,*) sdnco_bsn
      read (bsnfile_num,*) bact_swf
      read (bsnfile_num,*,iostat=eof) bactmx
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) bactminlp
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) bactminp
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) wdlprch
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) wdprch
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) wdlpres
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) wdpres
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) tb_adj
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) depimp_bsn
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) ddrain_bsn
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) tdrain_bsn
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) gdrain_bsn
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) cn_froz
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) dorm_hr
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) smxco  
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) fixco
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) nfixmx
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) anion_excl_bsn
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) ch_onco_bsn
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) ch_opco_bsn
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) hlife_ngw_bsn
      if (eof < 0) exit
      read (bsnfile_num,1000,iostat=eof) titldum    
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) bc1_bsn
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) bc2_bsn
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) bc3_bsn
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) bc4_bsn
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) decr_min
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) icfac
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) rsd_covco
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) vcrit
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) cswat
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) res_stlr_co
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) bf_flg
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) iuh 
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) uhalpha 
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) titldum
      read (bsnfile_num,'(a130)') tlu
       ...
       backspace(bsnfile_num)
       read (bsnfile_num,*) (lu_nodrain(kk), kk=1,numlu)
       

 !!   subdaily erosion modeling by Jaehak Jeong
      read (bsnfile_num,*,iostat=eof) titldum
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) eros_spl
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) rill_mult
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) eros_expo
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) sed_ch
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) c_factor
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) ch_d50
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) sig_g 
      if (eof < 0) exit
!!    Drainmod input variables - 01/2006
      read (bsnfile_num,*,iostat=eof) re_bsn
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) sdrain_bsn
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) drain_co_bsn
      if (eof < 0) exit
!!    Drainmod input variables - 01/2006
      read (bsnfile_num,*,iostat=eof) pc_bsn
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) latksatf_bsn
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) itdrn
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) iwtdn
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) sol_p_model  !! if = 1  use new soil P model
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) iabstr
      if (eof < 0) exit
!     iatmodep = 0 - average annual = 1 - monthly  2 = daily
      read (bsnfile_num,*,iostat=eof) iatmodep
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) r2adj_bsn ! Modified by D. Moriasi 4/8/2014
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) sstmaxd_bsn
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) ismax
      if (eof < 0) exit   
      read (bsnfile_num,*,iostat=eof) iroutunit
!!    Srin co2 (EPA)
      if (eof < 0) exit
      read (bsnfile_num,*,iostat=eof) co2_x2                !!R682 10/20/21 nbs
      if (eof < 0) exit                             !!R682 10/20/21 nbs
      read (bsnfile_num,*,iostat=eof) co2_x                 !!R682 10/20/21 nbs
      if (eof < 0) exit                             !!R682 10/20/21 nbs
!!    Srin co2 (EPA)                                !!R682 10/20/21 nbs
      read (bsnfile_num,*,iostat=eof) sfsedmean             !!R682 10/20/21 nbs
      if (eof < 0) exit                             !!R682 10/20/21 nbs
      read (bsnfile_num,*,iostat=eof) sfsedstdev            !!R682 10/20/21 nbs              
      exit
!!    Drainmod input variables - 01/2006
      end do
   
 !!!-----------------------Du-------------------water temperature---------------------------------------------
     !!---------Du----stream temperature-----------------------------------------
     
  
      if(iwtmp_rch==1 .or. iwtmp_sub==1) then
        select case(2)
        
        case(1)   !! F default
        do isub=1,msub
        wtmppara(isub,1,1)= 1                       ! date from
         wtmppara(isub,1,2)= 366                    ! date to 
          wtmppara(isub,1,3)= 0.1                  ! alpha   snowmelt water temperature
          wtmppara(isub,1,4)=3.2                 !AB      mu    ground water temperature, change for different watersheds
            ! wtmppara(isub,1,4)=10.5                !  UMRB    mu    ground water temperature, change for different watersheds
           ! wtmppara(isub,1,4)=9.4               !  SN    mu    ground water temperature, change for different watersheds
            wtmppara(isub,1,5)= 1.                ! gamma  
             wtmppara(isub,1,6)= 0.25               ! beta           K
              wtmppara(isub,1,7)= 0.                ! eta            e
               wtmppara(isub,1,8)= 7               ! lag      
        end do        
        
        case(2)   !! AB watershed calibration for F
          do isub=1,msub
        wtmppara(isub,1,1)=1                       ! date from
         wtmppara(isub,1,2)=90                    ! date to 
          wtmppara(isub,1,3)=0.1                  ! alpha
           wtmppara(isub,1,4)=3.2                 ! beta
            wtmppara(isub,1,5)=1.1                ! gamma
             wtmppara(isub,1,6)=0.1               ! beta
              wtmppara(isub,1,7)=12.                ! eta
               wtmppara(isub,1,8)=5                ! lag
        wtmppara(isub,2,1)=91
         wtmppara(isub,2,2)=300
          wtmppara(isub,2,3)=0.1
           wtmppara(isub,2,4)=3.2
            wtmppara(isub,2,5)=1.1
             wtmppara(isub,2,6)=0.05
              wtmppara(isub,2,7)=0.
               wtmppara(isub,2,8)=3
        wtmppara(isub,3,1)=301
         wtmppara(isub,3,2)=366
          wtmppara(isub,3,3)=0.1
           wtmppara(isub,3,4)=3.2
            wtmppara(isub,3,5)=1.1
             wtmppara(isub,3,6)=0.1
              wtmppara(isub,3,7)=9.
               wtmppara(isub,3,8)=5      
        end do        
        case(3)
          do isub=1,msub
        wtmppara(isub,1,1)=1                       ! date from
         wtmppara(isub,1,2)=60                    ! date to 
          wtmppara(isub,1,3)=1.0                  ! alpha
           wtmppara(isub,1,4)=1.0                 ! beta
            wtmppara(isub,1,5)=1.1                ! gamma
             wtmppara(isub,1,6)=0.3               ! beta
              wtmppara(isub,1,7)=5.                ! eta
               wtmppara(isub,1,8)=2                ! lag
        wtmppara(isub,2,1)=61
         wtmppara(isub,2,2)=300
          wtmppara(isub,2,3)=1.0
           wtmppara(isub,2,4)=1.0
            wtmppara(isub,2,5)=1.1
             wtmppara(isub,2,6)=0.15
              wtmppara(isub,2,7)=0.
               wtmppara(isub,2,8)=2 
        wtmppara(isub,3,1)=301
         wtmppara(isub,3,2)=366
          wtmppara(isub,3,3)=1.0
           wtmppara(isub,3,4)=1.0
            wtmppara(isub,3,5)=1.1
             wtmppara(isub,3,6)=0.3
              wtmppara(isub,3,7)=5.
               wtmppara(isub,3,8)=2      
        end do        
        end select           
...
!!    at some future time)
 ...
 5105 format (a4,a4,a4,a8,52a15)
 5106 format (a8,a4,a4,142a20)
 
 5107 format (a8,a4,a4,a8,264a20)
 5108 format (a8,a4,a4,181a20) 
 
 5109 format (a8,a4,a4,a8,80a20)
 5110 format (a8,a4,a4,108a20) 
