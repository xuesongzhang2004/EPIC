...
!! zero flow out variables
      ...
      if (ievent_rch > 0) then
      do ii = 1, nstep_rch
      hhvaroute(2,ihout,ii) = flomon(inum1,curyr,i_mo) / real(nstep_rch)
      hhvaroute(3,ihout,ii) = sedmon(inum1,curyr,i_mo) / real(nstep_rch)
      hhvaroute(4,ihout,ii) = orgnmon(inum1,curyr,i_mo) /real(nstep_rch)
      hhvaroute(5,ihout,ii) = orgpmon(inum1,curyr,i_mo) /real(nstep_rch)
      hhvaroute(6,ihout,ii) = no3mon(inum1,curyr,i_mo) / real(nstep_rch)
      hhvaroute(7,ihout,ii) = minpmon(inum1,curyr,i_mo) /real(nstep_rch)
      hhvaroute(11,ihout,ii) = solpstmon(inum1,curyr,i_mo) &
      		 / real(nstep_rch)
      hhvaroute(12,ihout,ii) = srbpstmon(inum1,curyr,i_mo) &
      		/ real(nstep_rch)
      hhvaroute(13,ihout,ii) = chlamon(inum1,curyr,i_mo)/real(nstep_rch)
      hhvaroute(14,ihout,ii) = nh3mon(inum1,curyr,i_mo) /real(nstep_rch)
      hhvaroute(15,ihout,ii) = no2mon(inum1,curyr,i_mo) /real(nstep_rch)
      hhvaroute(16,ihout,ii) = cbodmon(inum1,curyr,i_mo)/real(nstep_rch)
