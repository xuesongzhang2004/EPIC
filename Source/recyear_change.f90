...
!! zero flow out variables
      ...
      if (ievent_rch > 0) then
        do ii = 1, nstep_rch
          hhvaroute(2,ihout,ii) = floyr(inum1,curyr) / real(nstep_rch)
          hhvaroute(3,ihout,ii) = sedyr(inum1,curyr) / real(nstep_rch)
          hhvaroute(4,ihout,ii) = orgnyr(inum1,curyr) / real(nstep_rch)
          hhvaroute(5,ihout,ii) = orgpyr(inum1,curyr) / real(nstep_rch)
          hhvaroute(6,ihout,ii) = no3yr(inum1,curyr) / real(nstep_rch)
          hhvaroute(7,ihout,ii) = minpyr(inum1,curyr) / real(nstep_rch)
        hhvaroute(11,ihout,ii) = solpstyr(inum1,curyr) / real(nstep_rch)
        hhvaroute(12,ihout,ii) = srbpstyr(inum1,curyr) / real(nstep_rch)
          hhvaroute(13,ihout,ii) = chlayr(inum1,curyr) / real(nstep_rch)
          hhvaroute(14,ihout,ii) = nh3yr(inum1,curyr) / real(nstep_rch)
          hhvaroute(15,ihout,ii) = no2yr(inum1,curyr) / real(nstep_rch)
          hhvaroute(16,ihout,ii) = cbodyr(inum1,curyr) / real(nstep_rch)
         hhvaroute(17,ihout,ii) = disoxyr(inum1,curyr) / real(nstep_rch)
         hhvaroute(18,ihout,ii) = bactpyr(inum1,curyr) / real(nstep_rch)
        hhvaroute(19,ihout,ii) = bactlpyr(inum1,curyr) / real(nstep_rch)
         hhvaroute(20,ihout,ii) = cmtl1yr(inum1,curyr) / real(nstep_rch)
         hhvaroute(21,ihout,ii) = cmtl2yr(inum1,curyr) / real(nstep_rch)
         hhvaroute(22,ihout,ii) = cmtl3yr(inum1,curyr) / real(nstep_rch)
        end do
      end if
