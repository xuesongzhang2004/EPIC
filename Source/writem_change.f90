...
!       immo = immo + 1
        ...
        if (iprint /= 2 .and. curyr > nyskip) then
          ...
          if (iscen == 1) then
          write (output_std_num,6200) mo_chk, wshdmono(1), wshdmono(3), wshdmono(4),        &
          ...
          write (output2_std_num,6200) mo_chk, wshdmono(1), wshdmono(3), wshdmono(4),        &
                 wshdmono(104), wshdmono(5), wshdmono(109),                     &
                 wshddayo(35), wshdmono(7), wshdmono(108), wshdmono(6),         &
                 wshdmono(12), wshdmono(42), wshdmono(45),                      &
                 wshdmono(46), wshdmono(44), wshdmono(40),                      &
          ...
          if (iprint == 0) then
            !! monthly write--pesticide output (output.pes) for HRUs
            do j = 1, nhru
              if (hrupest(j) == 1) then
              sum = 0.
              do k = 1, npmx
              ...
              if (sum > 0. .and. iprp == 1) then
                write (output_pst_num,5100) subnum(j), hruno(j), iyr, mo_chk,		&       
            ...
            do j = 1, nres
              ...
              if (iyr > iyres(j) .or.           				&                        
                ...
                write (output_rsv_num,5800) j, mo_chk, res_vol(j),                   &
                ...
                write (output2_rsv_num,5800) j, mo_chk, res_vol(j),                  &
                           resoutm(1,j) / Real(idlast),                &
                           resoutm(2,j) / Real(idlast),                &
                           resoutm(19,j), resoutm(17,j), resoutm(18,j), &
                           resoutm(3,j), resoutm(4,j),                 &
                ...
                write (output_rsv_num,6800) j, mo_chk, res_vol(j),                   &
                           resoutm(1,j) / Real(idlast),                &
                           resoutm(2,j) / Real(idlast),                &
                           resoutm(19,j), resoutm(17,j), resoutm(18,j), &
                           resoutm(3,j), resoutm(4,j),                 &
 ...
 6200 format (i5,15f8.2,1x,4f8.2,60f8.2)
      end