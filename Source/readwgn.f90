...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      read (wgnfile_num,5000) titldum
      read (wgnfile_num,5100) wlat(i)
      read (wgnfile_num,5100) welev(i)
      read (wgnfile_num,5100) rain_yrs
      read (wgnfile_num,5200) (tmpmx(mon,i),mon = 1,12)
      read (wgnfile_num,5200) (tmpmn(mon,i),mon = 1,12)
      read (wgnfile_num,5200) (tmpstdmx(mon,i),mon = 1,12)
      read (wgnfile_num,5200) (tmpstdmn(mon,i),mon = 1,12)
      read (wgnfile_num,5201) (pcpmm(mon),mon = 1,12)
      read (wgnfile_num,5200) (pcp_stat(mon,2,i),mon = 1,12)  !pcpstd
      read (wgnfile_num,5200) (pcp_stat(mon,3,i),mon = 1,12)  !pcpskw
      read (wgnfile_num,5200) (pr_w(1,mon,i),mon = 1,12)
      read (wgnfile_num,5200) (pr_w(2,mon,i),mon = 1,12)
      read (wgnfile_num,5200) (pcpd(mon),mon = 1,12)
      read (wgnfile_num,5200) (rainhhmx(mon),mon = 1,12)
      read (wgnfile_num,5200) (solarav(mon,i),mon = 1,12)
      read (wgnfile_num,5200) (dewpt(mon,i),mon = 1,12)
      read (wgnfile_num,5200) (wndav(mon,i),mon = 1,12)
