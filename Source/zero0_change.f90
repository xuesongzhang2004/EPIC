...
!    Drainmod tile equations  01/2006
      ...
      fcstcnt = 0
      fertnm = ""
      ffc = 0.99                !soil_phys.f90(175):        sol_st(j,i) = sol_fc(j,i) * ffc(i)
      ffcst = 0
      filterw = 0.
      fimp = 0.
      fld_fr = 0.
...
!      wshddayo = 0.
      ...
      !initialize flood routing variables                         !!R666b 7/19/17 nbs
      do i=1,4
          IHX(i) = i
      end do
      QHY = 0.
      ...
      MaxRate= 0.  !! 0.15 
      N2Oadjust_wp= 0.   !0.002
      N2Oadjust_fc= 0.  !0.015
      min_nitrate= 0.  !0.1
      wfpsdnitadj = 0.   ! 1.1
      !!-----------co2---qichun-----------------------------
      co2con = 0.
      ...
      !-----------------For organic carbon module---added by Du------------!
      cbn_hru%rchrg_doc=0.
      !------------------output-----------------------------------------!
      !rch_algcon=0.
