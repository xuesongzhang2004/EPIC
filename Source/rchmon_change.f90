...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      do j = 1, subtot
        ...
        srch_av(12) = rchmono(60,j) / Real(mdays)          !water temp
        ...
        pdvar(2) = srch_av(2)      !!flow out (m^3/s)      £¡£¡7
        pdvar(3) = srch_av(10)     !!evaporation (m^3/s)
        pdvar(4) = srch_av(11)     !!tloss (m^3/s)
        pdvar(5) = rchmono(3,j)    !!sed in (metric tons)
        pdvar(6) = rchmono(4,j)    !!sed out (met tons)     £¡£¡11
        pdvar(7) = srch_av(5)      !!sed conc (mg/L)      12
        pdvar(8) = rchmono(6,j)    !!orgN in (kg N)      13
        pdvar(9) = rchmono(7,j)    !!orgN out (kg N)    14
        pdvar(10) = rchmono(8,j)   !!orgP in (kg P)      15
        pdvar(11) = rchmono(9,j)   !!orgP out (kg P)    16
        pdvar(12) = rchmono(15,j)  !!NO3 in (kg N)    17
        pdvar(13) = rchmono(16,j)  !!NO3 out (kg N)    18
        pdvar(14) = rchmono(32,j)  !!NH4 in (kg)     19
        pdvar(15) = rchmono(33,j)  !!NH4 out (kg)      20
        pdvar(16) = rchmono(34,j)  !!NO2 in (kg)      21
        pdvar(17) = rchmono(35,j)  !!NO2 out (kg)     22
        pdvar(18) = rchmono(17,j)  !!solP in (kg P)     23
        pdvar(19) = rchmono(18,j)  !!solP out (kg P)    24
        pdvar(20) = rchmono(30,j)  !!algae in (kg)      25
        ...
        pdvar(38) = rchmono(40,j)  !!p bact out           43
        pdvar(39) = rchmono(41,j)  !!lessp bact out      44
        pdvar(40) = rchmono(12,j)  !!metal #1            45
        pdvar(41) = rchmono(13,j)  !!metal #2           46
        pdvar(42) = rchmono(14,j)  !!metal #3           47
 !! added for Total N (org N + no3 + no2 + nh4 outs) to output.rch gsm 10/17/2011
        pdvar(43) = rchmono(7,j)+ rchmono(16,j) + rchmono(35,j) + &
			 rchmono(33,j)                                                  !! Total N                              48  
 !! added for Total P (org P + sol p outs)to output.rch gsm 10/17/2011           
        pdvar(44) = rchmono(9,j) + rchmono(18,j)                        !! Total P                49
 !! added NO3 Concentration to output.rch (for daily only) gsm 10/26/2011
        pdvar(46) = srch_av(12)    !!----stream temperature---------------------------
 
   !----assign monthly output values for carbon module,added by Du--------------!
        pdvar(47) = rchmono(63,j)               !!RPOC in (kg C)
        pdvar(48) = rchmono(64,j)               !!RPOC out (kg C)
        pdvar(49) = rchmono(65,j)               !!LPOC in (kg C)
        pdvar(50) = rchmono(66,j)               !!LPOC in (kg C)
        pdvar(51) = rchmono(67,j)               !!RDOC in (kg C)
        pdvar(52) = rchmono(68,j)               !!RDOC out (kg C)
        pdvar(53) = rchmono(69,j)               !!LDOC in (kg C)
        pdvar(54) = rchmono(70,j)               !!LDOC in (kg C)
        pdvar(55) = rchmono(71,j)               !!DIC in (kg C))
        pdvar(56) = rchmono(72,j)               !!DIC out (kg C))
        pdvar(57) = rchmono(64,j)+rchmono(66,j) !!Total POC out (kg C)   £¡£¡62
        pdvar(58) = rchmono(68,j)+rchmono(70,j) !!Total DOC out (kg C)   £¡£¡63
 ...
 !  increase to 44 in loops below from 42 gsm 10/17/2011      
      ...
      return
 5000 format ('REACH ',i5,1x,i8,1x,i5,47e12.4,13e12.4)      !!R666b 7/19/17 nbs
 6000 format ('REACH ',i5,1x,i8,1x,i5,47e12.4,1x,i4)        !!R666b 7/19/17 nbs
      end