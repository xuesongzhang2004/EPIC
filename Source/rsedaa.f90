...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      real :: years
      do j = 1, subtot
          write (output_sed_num,5000) j, subgis(j), years, rch_dakm(j),	rchaao(3,j), rchaao(4,j),(rchaao(ii,j),ii=42,58)
      end do

      return
 5000 format ('REACH ',i6,1x,i8,1x,f5.1,20e12.4)            !!R682 10/20/21 nbs
      end