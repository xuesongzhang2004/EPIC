...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      real :: rc, rho, rout, d, chz, gsi_adj, pet_alpha, ee
      real :: co2adj   !!---------qichun-----co2-----------------
       ...
       !! net radiation
        ...
        !! potential ET: reference crop alfalfa at 40 cm height
           ...
           rv = 114. / (u10(j) * (170./1000.)**0.2)
            !!---------qichun co2-------------------------------------------------------------------
           if(ico2==0) rc = 49. / (1.4 - 0.4 * co2(hru_sub(j)) / 330.)
           if(ico2==1) rc = 49. / (1.4 - 0.4 * co2con(iyr) / 330.)
            !!--------qichun co2------------------------------------------------------------------- 
        ...
        !! maximum plant ET
          ...
          !!---------------qichun co2-----------------------------------------------------------------
           if(ico2==1) then
            ...
            if (idplt(j).EQ.7 .or. idplt(j).EQ.6 ) then
              co2adj = 0.24
            else if (idplt(j).EQ.8) then
              co2adj = 0.08
            else if ((idplt(j).EQ.51) .OR.(idplt(j).EQ.22)          &
                .OR.(idplt(j).EQ.12).OR.(idplt(j).EQ.13)            &
                .OR.(idplt(j).EQ.14).OR.(idplt(j).EQ.25)            &
                .OR.(idplt(j).EQ.36).OR.(idplt(j).EQ.37)            &
                .OR.(idplt(j).EQ.39).OR.(idplt(j).EQ.40)            &
                .OR.(idplt(j).EQ.41).OR.(idplt(j).EQ.42)            &
                .OR.(idplt(j).EQ.43).OR.(idplt(j).EQ.44)            &
                .OR.(idplt(j).EQ.50) ) then
              co2adj = 0.26
            else if ((idplt(j).EQ.15) 			&
                .OR.(idplt(j).EQ.16).OR.(idplt(j).EQ.17)) then
              co2adj = 0.21
            else
              co2adj = 0.4
            ...
            rc = rc / (0.5 * (laiday(j) + 0.01)     			&                    
                       * ((1.+co2adj )- co2adj  * co2con(iyr) / 330.))  
