...
!!    Plus particle size tracking.
      ...
      real :: sedinorg, deg1, deg1san, deg1sil, deg1sag, deg1cla, deg1lag, deg1gra, degremain, c, pbed, pbank, rh, topw, sfbank, vsh, var1, var2
      real :: log10
      real :: w50, var3, var4, var5, var6, var56, alog10cychppm, cychppm, cychw, cychv, vgra, vsan, vsil, vcla, vsag, vlag, dat2
