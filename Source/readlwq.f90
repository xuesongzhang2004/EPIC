...
!!    read lake water quality data    
      do 
        read (lwqfile_num,1000,iostat=eof) titldum
        if (eof < 0) exit
        read (lwqfile_num,1000,iostat=eof) titldum
        if (eof < 0) exit
        read (lwqfile_num,*,iostat=eof) ires1(i)
        if (eof < 0) exit
        read (lwqfile_num,*,iostat=eof) ires2(i)
        if (eof < 0) exit
        read (lwqfile_num,*,iostat=eof) psetlr(1,i)
        if (eof < 0) exit
        read (lwqfile_num,*,iostat=eof) psetlr(2,i)
        if (eof < 0) exit
        read (lwqfile_num,*,iostat=eof) nsetlr(1,i)
        if (eof < 0) exit
        read (lwqfile_num,*,iostat=eof) nsetlr(2,i)
        if (eof < 0) exit
        read (lwqfile_num,*,iostat=eof) chlar(i)
        if (eof < 0) exit
        read (lwqfile_num,*,iostat=eof) seccir(i)
        if (eof < 0) exit
        read (lwqfile_num,*,iostat=eof) orgpi
        if (eof < 0) exit
        read (lwqfile_num,*,iostat=eof) solpi
        if (eof < 0) exit
        read (lwqfile_num,*,iostat=eof) orgni
        if (eof < 0) exit
        read (lwqfile_num,*,iostat=eof) no3i
        if (eof < 0) exit
        read (lwqfile_num,*,iostat=eof) nh3i
        if (eof < 0) exit
        read (lwqfile_num,*,iostat=eof) no2i
        if (eof < 0) exit
        read (lwqfile_num,1000,iostat=eof) titldum
        if (eof < 0) exit
        read (lwqfile_num,*,iostat=eof) lkpst_conc(i) 
        if (eof < 0) exit
        read (lwqfile_num,*,iostat=eof) lkpst_rea(i)
        if (eof < 0) exit
        read (lwqfile_num,*,iostat=eof) lkpst_vol(i) 
        if (eof < 0) exit
        read (lwqfile_num,*,iostat=eof) lkpst_koc(i) 
        if (eof < 0) exit
        read (lwqfile_num,*,iostat=eof) lkpst_stl(i) 
        if (eof < 0) exit
        read (lwqfile_num,*,iostat=eof) lkpst_rsp(i)
        if (eof < 0) exit
        read (lwqfile_num,*,iostat=eof) lkpst_mix(i)
        if (eof < 0) exit
        read (lwqfile_num,*,iostat=eof) lkspst_conc(i) 
        if (eof < 0) exit
        read (lwqfile_num,*,iostat=eof) lkspst_rea(i)
        if (eof < 0) exit
        read (lwqfile_num,*,iostat=eof) lkspst_bry(i) 
        if (eof < 0) exit
        read (lwqfile_num,*,iostat=eof) lkspst_act(i)
        if (eof < 0) exit
        read (lwqfile_num,*,iostat=eof) theta_n(i)
        if (eof < 0) exit
        read (lwqfile_num,*,iostat=eof) theta_p(i)
        if (eof < 0) exit
