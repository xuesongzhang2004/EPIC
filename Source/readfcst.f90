...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      read (fcstfile2_num,5000) titldum
      read (fcstfile2_num,5100) fcstregtot

      do j = 1, fcstregtot
        read (fcstfile2_num,5000) titldum
        read (fcstfile2_num,5100) i    !forecast region number
          if (i <= 0 ) i = 1
        read (fcstfile2_num,5200) (ftmpmx(mon,i),mon = 1,12)
        read (fcstfile2_num,5200) (ftmpmn(mon,i),mon = 1,12)
        read (fcstfile2_num,5200) (ftmpstdmx(mon,i),mon = 1,12)
        read (fcstfile2_num,5200) (ftmpstdmn(mon,i),mon = 1,12)
        read (fcstfile2_num,5200) (pcpmm(mon),mon = 1,12)
        read (fcstfile2_num,5200) (fpcp_stat(mon,2,i),mon = 1,12)  !pcpstd
        read (fcstfile2_num,5200) (fpcp_stat(mon,3,i),mon = 1,12)  !pcpskw
        read (fcstfile2_num,5200) (fpr_w(1,mon,i),mon = 1,12)
        read (fcstfile2_num,5200) (fpr_w(2,mon,i),mon = 1,12)
        read (fcstfile2_num,5200) (pcpd(mon),mon = 1,12)
