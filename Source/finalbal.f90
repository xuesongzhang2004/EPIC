...
!!    ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!!    j           |none          |counter
!!    ress3        |metric tons   |sediment entering all reservoirs
!!    ress4        |metric tons   |sediment leaving all reservoirs
...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      integer :: j
      real :: tir, wshd_snoe, volout, sedout, ress3, ress4, res17
...
!! check reservoir water and sediment balance
      if (wshd_resha > 1.e-4) then
        ...
        sedout = 0.
        do j = 1, nres
          ress3 = ress3 + resouta(3,j)
          ress4 = ress4 + resouta(4,j)
        ...
        call vbl(res17,res18,res19,res20,res21,wshd_resv,wshd_ressed,   &
                ress3,ress4,0.,volout,sedout,wshd_resha)
      end if
