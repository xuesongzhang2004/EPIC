...
!! zero flow out variables
      ...
      if (ievent_rch > 0) then
        do ii = 1,nstep_rch
          hhvaroute(2,ihout,ii) = flocnst(inum1) / real(nstep_rch)
          hhvaroute(3,ihout,ii) = sedcnst(inum1) / real(nstep_rch)
          hhvaroute(4,ihout,ii) = orgncnst(inum1) / real(nstep_rch)
          hhvaroute(5,ihout,ii) = orgpcnst(inum1) / real(nstep_rch)
          hhvaroute(6,ihout,ii) = no3cnst(inum1) / real(nstep_rch)
          hhvaroute(7,ihout,ii) = minpcnst(inum1) / real(nstep_rch)
          hhvaroute(11,ihout,ii) = solpstcnst(inum1) / real(nstep_rch)
          hhvaroute(12,ihout,ii) = srbpstcnst(inum1) / real(nstep_rch)
          hhvaroute(13,ihout,ii) = chlacnst(inum1) / real(nstep_rch)
          hhvaroute(14,ihout,ii) = nh3cnst(inum1) / real(nstep_rch)
          hhvaroute(15,ihout,ii) = no2cnst(inum1) / real(nstep_rch)
          hhvaroute(16,ihout,ii) = cbodcnst(inum1) / real(nstep_rch)
          hhvaroute(17,ihout,ii) = disoxcnst(inum1) / real(nstep_rch)
          hhvaroute(18,ihout,ii) = bactpcnst(inum1) / real(nstep_rch)
          hhvaroute(19,ihout,ii) = bactlpcnst(inum1) / real(nstep_rch)
          hhvaroute(20,ihout,ii) = cmtl1cnst(inum1) / real(nstep_rch)
          hhvaroute(21,ihout,ii) = cmtl2cnst(inum1) / real(nstep_rch)
          hhvaroute(22,ihout,ii) = cmtl3cnst(inum1) / real(nstep_rch)
        end do
      end if
