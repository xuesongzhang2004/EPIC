...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      pdvab(8) = sub_gwq(sb) 
      pdvab(9) = sub_wyld(sb)
      pdvab(10) = sub_sur_tmp(sb)
      pdvab(11) = sub_soltmp_50(sb)
      pdvab(12) = sub_soltmp_100(sb)
      pdvab(13) = sub_soltmp_200(sb)
      pdvab(14) = sub_soltmp_500(sb)
      pdvab(15) = sub_soltmp_1000(sb)
      pdvab(16) = 9999
      pdvab(17) = sub_sur_tmp(sb)
      pdvab(18) = sub_soltmp_50(sb)
      pdvab(19) = sub_soltmp_100(sb)
      pdvab(20) = sub_soltmp_150(sb)
      pdvab(21) = sub_soltmp_200(sb)
      pdvab(23) = sub_soltmp_300(sb)     !! tile flow  jane f.
      pdvab(22) = sub_soltmp_500(sb)    !! tileno3
      pdvab(24) = sub_soltmp_1000(sb)    !! phos due to crack flow
...
!1000 format ('BIGSUB',i4,1x,i8,1x,i4,e10.5,21f10.3)
 1000 format ('BIGSUB',i4,1x,i8,1x,i4,e10.5,16f10.3,1x,8f10.3)
