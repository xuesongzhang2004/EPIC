...
!! initialize variables
      ...
      if (ifirstr(inum1) == 0) then
          read (day_in_num+inum1,*) idap, iyp, floday, sedday, orgnday,       & 
      ...
      if (ievent_rch > 0) then
        do ii = 1, nstep_rch
          hhvaroute(2,ihout,ii) = floday / real(nstep_rch)
          hhvaroute(3,ihout,ii) = sedday / real(nstep_rch)
          hhvaroute(4,ihout,ii) = orgnday / real(nstep_rch)
          hhvaroute(5,ihout,ii) = orgpday / real(nstep_rch)
          hhvaroute(6,ihout,ii) = no3day / real(nstep_rch)
          hhvaroute(7,ihout,ii) = minpday / real(nstep_rch)
          hhvaroute(11,ihout,ii) = solpstday / real(nstep_rch)
          hhvaroute(12,ihout,ii) = srbpstday / real(nstep_rch)
          hhvaroute(13,ihout,ii) = chladay / real(nstep_rch)
          hhvaroute(14,ihout,ii) = nh3day / real(nstep_rch)
          hhvaroute(15,ihout,ii) = no2day / real(nstep_rch)
          hhvaroute(16,ihout,ii) = cbodday / real(nstep_rch)
          hhvaroute(17,ihout,ii) = disoxday / real(nstep_rch)
          hhvaroute(18,ihout,ii) = bactpday / real(nstep_rch)
          hhvaroute(19,ihout,ii) = bactlpday / real(nstep_rch)
          hhvaroute(20,ihout,ii) = cmtl1day / real(nstep_rch)
          hhvaroute(21,ihout,ii) = cmtl2day / real(nstep_rch)
          hhvaroute(22,ihout,ii) = cmtl3day / real(nstep_rch)
        end do
      end if
