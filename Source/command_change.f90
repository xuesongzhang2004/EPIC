      ...
      do ii = 1, mhyd_bsn
        ...
        select case (icode)
          ...
          case (2) 
            call route
             ...
             if(ievent_rch==1)then    
                if (dtp_onoff(inum1)==1) call bmp_det_pond  !route detention pond J.Jeong feb 2010     !R668 1/30/2018 nbs 
                if (wtp_onoff(inum1)==1) call bmp_wet_pond  !route wetention pond J.Jeong june 2010     !R668 1/30/2018 nbs
            end if
          ...
          case (13) 
            call apex_day
          case (14)
            if (curyr > nyskip) call saveconc      !!R680 4/30/20 nbs
          case (17)
            call routeunit
            call sumhyd
          case (18)
