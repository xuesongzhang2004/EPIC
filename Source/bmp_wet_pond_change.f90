      subroutine bmp_wet_pond               !R668 1/30/2018 nbs
...
!!       Seepage, evaporation and rainfall
         ...
         seep = wtp_k(sb) / 1000. / 60. * idt_rch *  seepa !m3
...
!!       Sediment removal
         ...
         if(qout>0.) then
            !WERF equation
            qhyd = qout / idt_rch / 60. / surfa * 100.  ! m3/s / m2 * 100 = cm/s
            coeff_R = (1.+ usettle / 	&
            ...
            decayexp = exp(-7.667e-3 * idt_rch / 60. * dp)
      ...
      end subroutine bmp_wet_pond           !!R668 1/30/2018 nbs
