...
!!     of septic documentation. Data were compiled from Siegrist et al, 2005 and McCray et al,2007. 
      ...
      integer :: ist, isnum, eof, ii, idspttype
...
!!    septic database filename present in file.cio
      if (septdb /= '             ') then
        open (septdb_num,file=septdb)
	

!!    read title lines
         do ii = 1, 4
          read (septdb_num,5999) titlesep
        end do
	  ...
	  sptfcoli = 0.
        ...
        read (septdb_num,6000,iostat=eof)ist,sptname,sptfullname,idspttype,        &
