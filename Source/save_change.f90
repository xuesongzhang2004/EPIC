...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      !inum1: file number
      !inum2: print frequency !! (0=daily) (1=hourly)
      !inum3: print format    |   (0=normal, fixed format), |   (1=txt format for AV interface,recday)
      ...
      if (ievent_rch == 1 .and. inum2 == 1) then
        ...
        do ii = 1, nstep_rch
          if (inum3 == 0) then
            write (day_save_num+inum1,5000) iida, iyr, ii-1,   &                   
        ...
        if (inum3 == 0) then
          write (day_save_num+inum1,5002) iida, iyr,          &                    
                           varoute(2,ihout),        &                   
                           varoute(3,ihout),        &                   
                           varoute(4,ihout),        &                   
                           varoute(5,ihout),        &                   
