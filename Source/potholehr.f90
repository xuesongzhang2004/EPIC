...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      real :: potno3o, potsolpo, potorgno, potorgpo, potmpso, potmpao, rto, qin, pot_depth
      real :: drcla, drsil, drtot, potflow, tileo
      j = 0
      j = ihru
...
!       compute evaporation from water surface  NUBZ - I moved this before the if(pot_vol
          ...
          if (iprint==3) then
		  write (output_pot_num,2000)i,j,curyr,k,pot_vol(j),potsa(j),spillo,potsep,   &
